...
class CampaignsAllRequest extends CampaignsRequest implements AllInterface
{
	...
	private const PARAM_SINCE_SEND_TIME = 'since_send_time';
	private const PARAM_BEFORE_SEND_TIME = 'before_send_time';
	private const PARAM_SINCE_CREATE_TIME = 'since_create_time';
	private const PARAM_BEFORE_CREATE_TIME = 'before_create_time';
